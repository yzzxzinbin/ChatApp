...
const QString FT_MSG_DATA_ACK_FORMAT = QStringLiteral("<FT_ACK_DATA TransferID=\"%1\" ChunkID=\"%2\" ReceiverUUID=\"%3\"/>"); // ChunkID is highest contiguous received
...
const qint64 DEFAULT_CHUNK_SIZE = 4096 * 1024; // 2048KB chunks
